...
url='https://book.douban.com/people/cynthia717/wish?start=15&sort=time&rating=all&filter=all&mode=grid'
...
for id in range(0, end, 15):
    ...
    with open('./want_read/douban' + str(id) + '.html', 'wb+') as f:
    ...
    for region in regions:
        ...
        book['want_read_date'] = short_note.find('span', class_ = 'date').text.strip()
...
with open('wish_books_2.json', 'w') as f:
